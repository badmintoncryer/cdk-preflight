...
<p align="center">
  ...
  <a href="docs/rules.md"><img src="https://img.shields.io/badge/rules-2241-blue" alt="2241 bundled rules"></a>
</p>
...
<details>
<summary><b>279 resource types across 44 services</b> — click to expand</summary>
...
| **Glue** | `Crawler` (7), `Job` (15), `Trigger` (9), `Workflow` (1) |
