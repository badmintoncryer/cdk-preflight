...
<p align="center">
  ...
  <a href="docs/rules.md"><img src="https://img.shields.io/badge/rules-2252-blue" alt="2252 bundled rules"></a>
</p>
...
<details>
<summary><b>282 resource types across 44 services</b> — click to expand</summary>
...
| **Glue** | `Classifier` (6), `Connection` (3), `Crawler` (8), `Job` (15), `SecurityConfiguration` (1), `Trigger` (9), `Workflow` (1) |
