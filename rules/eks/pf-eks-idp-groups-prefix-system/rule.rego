...
violation contains make_diag_full("pf-eks-idp-groups-prefix-system", "ERROR", name,
	"Properties.Oidc.GroupsPrefix",
	"GroupsPrefix is \"system:\", which Kubernetes reserves (\"The prefix system: is reserved for Kubernetes system use\")",
	...
	resolve(name, "Properties.Oidc.GroupsPrefix") == "system:"
}
