...
violation contains make_diag_full("pf-route53profiles-profileresourceassociation-querylogging-max", "ERROR", name,
	...
	sprintf("this template associates %d Resolver query logging configs with the same Profile; the limit is 2", [n]),
	"Associate at most 2 query logging configs per Profile",
