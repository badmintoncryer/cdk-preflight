...
violation contains make_diag_full("pf-servicediscovery-instance-a-requires-ipv4", "ERROR", name,
	"Properties.InstanceAttributes.AWS_INSTANCE_IPV4",
	sprintf("A A record is published by service '%v', but this instance has no AWS_INSTANCE_IPV4; RegisterInstance fails with \"Required attribute(s) AWS_INSTANCE_IPV4 are missing.\"", [svc]),
	"Add AWS_INSTANCE_IPV4 to InstanceAttributes",
