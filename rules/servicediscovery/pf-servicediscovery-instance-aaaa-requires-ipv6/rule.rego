...
violation contains make_diag_full("pf-servicediscovery-instance-aaaa-requires-ipv6", "ERROR", name,
	"Properties.InstanceAttributes.AWS_INSTANCE_IPV6",
	sprintf("A AAAA record is published by service '%v', but this instance has no AWS_INSTANCE_IPV6; RegisterInstance fails with \"Required attribute(s) AWS_INSTANCE_IPV6 are missing.\"", [svc]),
	"Add AWS_INSTANCE_IPV6 to InstanceAttributes",
	...
	"AAAA" in _pf_sd_record_types(svc)
