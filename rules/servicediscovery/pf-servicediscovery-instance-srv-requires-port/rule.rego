...
violation contains make_diag_full("pf-servicediscovery-instance-srv-requires-port", "ERROR", name,
	"Properties.InstanceAttributes.AWS_INSTANCE_PORT",
	sprintf("A SRV record is published by service '%v', but this instance has no AWS_INSTANCE_PORT; RegisterInstance fails with \"Required attribute(s) AWS_INSTANCE_PORT are missing.\"", [svc]),
	"Add AWS_INSTANCE_PORT to InstanceAttributes",
